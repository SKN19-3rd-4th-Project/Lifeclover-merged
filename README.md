...
| 정보 검색 실패   | DB 내 연관된 데이터를 제대로 활용하지 못함    |
| 조건 반영 미흡   | 앞선 문맥을 파악하지 못해 예상과 다른 답변 출력 |
...
|-------------|------------------------------------------------------|
| 구조 보완   | 출력 문구의 구조 재구성               |
| 정보 검색 개선     | 데이터 연관성을 보완하고, 사용자에게 정확한 질문 방법 제시   |
| 문맥 프롬프트 조치 | 프롬프트 수정으로 자연스러운 대화 가능하도록 조치          |

---

### 5. 개선 전 / 후 비교 (정보 탭 응답 예시)
...
### 5. 개선 전 / 후 비교(이건 실제 챗봇 테스트 이미지 필요.)
